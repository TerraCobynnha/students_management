    ...
    <section id="breadcrumb">
      <div class="container">
        <ol class="breadcrumb">
          ...
          <li class="active">Edit Records</li>
        </ol>
      </div>
    </section>
        ...
        <div class="col-sm-12">
          <div class="panel panel-info">
            <div class="panel-heading">
              <h3 class="panel-title text-center">Edit a Record</h3>
            </div>
            <div class="panel-body">
              <div class="well text-center" id="optionchoose">
                  <a class="btn btn-primary btn-lg" href="edit-student.php">Student Record</a>
                  <a class="btn btn-info btn-lg" href="edit-staff.php">Staff Record</a>
              </div>
