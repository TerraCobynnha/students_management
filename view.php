        ...
        <div class="col-sm-12">
          <div class="panel panel-info">
            <div class="panel-heading">
              <h3 class="panel-title text-center">View Records</h3>
            </div>
            <div class="panel-body">
              <div class="well text-center" id="optionchoose">
                  <a class="btn btn-primary btn-lg" href="view-student.php">Student Record</a>
                  <a class="btn btn-info btn-lg" href="view-staff.php">Staff Record</a>
              </div>
