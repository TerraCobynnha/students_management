<?php
  ...
  if (isset($_GET['edit-id'])) {
    ...
    $sqlEdit = "SELECT * FROM studentdetails WHERE std_id='$idEdit';";
              ...
              <table class="table table-striped table-hover">
                ...
                <?php while ($row = mysqli_fetch_assoc($result)) :?>
                  ...
                  <tr class="view-record-entry">
                    ...
                    <td><a href="edit-student.php?edit-id=<?php echo $row['std_id']; ?>" class="btn btn-primary edit-btn">Edit</a></td>
                  </tr>
        ...
        <div class="modal-content">
          <form action="includes/process.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="modal-body">
              ...
              <!-- Hidden form input-->
              <input type="hidden" name="ed-id" value="<?php echo $rowEdit['std_id']; ?>">

              <div class="form-group">
                <label for="firstName">First Name</label>
                <input class="form-control" type="text" name="firstName" placeholder="First name..." value="<?php echo $rowEdit['std_first']; ?>">
              </div>
              <div class="form-group">
                <label for="lastName">Last Name</label>
                <input class="form-control" type="text" name="lastName" placeholder="Last name..." value="<?php echo $rowEdit['std_last']; ?>">
              </div>
              <div class="form-group">
                <label for="dob">Date of Birth</label>
                <input class="form-control" type="date" name="dob" value="<?php echo $rowEdit['std_dob']; ?>">
              </div>
              <div class="form-group">
                <label for="sex">Sex: </label>
                <input class="form-control" type="text" name="sex" value="<?php echo $rowEdit['std_sex'];?>" list="sexoptions">
              ...
              <div class="form-group">
                ...
                <input class="form-control" type="text" name="hall" placeholder="Hall name..." value="<?php echo $rowEdit['std_hall']; ?>">
              </div>
              <div class="form-group">
                <label for="course">Course</label>
                <input class="form-control" type="text" name="course" placeholder="Course..." value="<?php echo $rowEdit['std_course']; ?>">
              </div>
            </div>
